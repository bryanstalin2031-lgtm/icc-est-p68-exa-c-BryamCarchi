...
public class TournamentTestData {
    ...
    public static Tournament[] createTournaments() {
        ...
        Tournament copaAndina = new Tournament("Copa Andina",
                new Club[] { new Club("Condor FC", condorAthletes), new Club("Quito United", quitoAthletes) });
        ...
        Tournament torneoAltura = new Tournament("Torneo Altura",
                new Club[] { new Club("Sierra Norte", sierraAthletes), new Club("Volcan Rojo", volcanAthletes) });
        ...
        Tournament supercopaCapital = new Tournament("Supercopa Capital",
                new Club[] { new Club("Centro Atletico", centroAthletes), new Club("Metro Club", metroAthletes) });
        ...
        Tournament mastersNacional = new Tournament("Masters Nacional",
                new Club[] { new Club("Titanes", titanAthletes), new Club("Campeon FC", campeonAthletes) });
        ...
        Tournament copaCosta = new Tournament("Copa Costa",
                new Club[] { new Club("Bahia Norte", bahiaAthletes), new Club("Ola Azul", olaAthletes) });
        ...
        Tournament ligaMetro = new Tournament("Liga Metropolitana",
                new Club[] { new Club("Norte SC", norteAthletes), new Club("Sur Deportivo", surAthletes) });
